# Antigravity Agent Guidelines & Rules: Universal Git Workflow

## 🌿 Git Branching & Feature Workflow Rules

### 1. STRICT PROHIBITION: NO CODING OR COMMITTING ON MAIN
- **Agents of ANY type, persona, model, or tool are STRICTLY FORBIDDEN from writing, modifying, creating, or editing code files while on the `main` branch.**
